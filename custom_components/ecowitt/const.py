...
SENSOR_TYPES = {
    ...
    TYPE_WH26BATT: ("WH26 Battery", "BATT", TYPE_BINARY_SENSOR,
                    DEVICE_CLASS_BATTERY, "mdi:battery", 0),
    TYPE_WH40BATT: ("WH40 Battery", VOLT, TYPE_SENSOR,
    ...
    TYPE_WH65BATT: ("WH65 Battery", "BATT", TYPE_BINARY_SENSOR,
                    DEVICE_CLASS_BATTERY, "mdi:battery", 0),
    TYPE_WH68BATT: ("WH68 Battery", VOLT, TYPE_SENSOR,
                    DEVICE_CLASS_BATTERY, "mdi:battery", 0),
    TYPE_WH80BATT: ("WH80 Battery", VOLT, TYPE_SENSOR,
                    DEVICE_CLASS_BATTERY, "mdi:battery", 0),
    TYPE_SOILBATT1: ("Soil Moisture 1 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT2: ("Soil Moisture 2 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT3: ("Soil Moisture 3 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT4: ("Soil Moisture 4 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT5: ("Soil Moisture 5 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT6: ("Soil Moisture 6 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT7: ("Soil Moisture 7 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT8: ("Soil Moisture 8 Battery", VOLT, TYPE_SENSOR,
                     DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
